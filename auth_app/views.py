...
from .serializers import (ActivateInviteSerializer, LogoutSerializer,
                          PhoneNumberSerializer, RefreshSerializer,
                          VerifySerializer)
...
class SendCodeView(APIView):
    ...
    def post(self, request):
        ...
        return Response(
            {"message": "Код авторизации отправлен", "phone_number": phone_number}
        )
...
class VerifyCodeView(APIView):
    ...
    @swagger_auto_schema(
        request_body=VerifySerializer, responses={200: "Успешно", 400: "Ошибка"}
    )
    def post(self, request):
